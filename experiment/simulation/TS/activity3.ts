...
var conc: number;
let slider_index: number;
var sel_index: number = -1;
var inner_index: number = 0;

let sem1: Chemistry.SemiCircle;
let sem2: Chemistry.SemiCircle;

let angle_val: number;


// new code starts here

var dd_value: string = '';
var standard_value: number;
...
function load_sugar_dd() {
  let dd: HTMLDivElement = <HTMLDivElement> document.createElement('div');
...
function set_dd_value() {
  let dd: HTMLSelectElement = <HTMLSelectElement> document.getElementById('sugar-dd');
...
function sel_conc() {
  let sel_2: HTMLSelectElement = <HTMLSelectElement> document.getElementById('concentration-1');
  conc = parseFloat(sel_2.value);
  let sdr: HTMLInputElement = <HTMLInputElement> document.getElementById('s-1');
  sdr.disabled = false;
  ...
  let btn: HTMLInputElement = <HTMLInputElement> document.getElementById('act3-nxt-btn');
  btn.disabled = false;
...
function set_position_1() {
  ...
  let slider_1: HTMLInputElement = <HTMLInputElement> document.getElementById('s-1');
...
function set_position_2() {
  ...
  let slider_2: HTMLInputElement = <HTMLInputElement> document.getElementById('s-2');
...
function position_1_change() {
  ...
  let slider_1: HTMLInputElement = <HTMLInputElement> document.getElementById('s-1');
  let show1: HTMLInputElement = <HTMLInputElement> document.getElementById('show-s1');
...
function position_2_change() {
  ...
  let slider_2: HTMLInputElement = <HTMLInputElement> document.getElementById('s-2');
  let show2: HTMLInputElement = <HTMLInputElement> document.getElementById('show-s2');
