...
function activity7() {
    ...
    <div>
        ...
        <div>
            <p>Standard Value of Specific Rotation of ${dd_value} ==> ${main_table_data[
		sel_index
	].data[0][4].toFixed(2)}</p>
            <p>Experimental Value of Specific Rotation of ${dd_value} ==> ${calculated_s.toFixed(
		2
	)}</p>
        </div>
