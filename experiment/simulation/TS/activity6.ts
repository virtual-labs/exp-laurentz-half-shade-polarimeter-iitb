...
var calculated_slope: number;
var calculated_s: number;
...
function draw_chart() {
	...
	let calc_slope = `<div style="
   position: absolute; bottom: 12vh; width: 90%;">
    <p>Enter the values of X1 (x coordinate) value: <input type="number" name="" id="x1"></p>
    <p>Enter the values of X2 (x coordinate) value: <input type="number" name="" id="x2"></p>
    <p>Enter the values of Y1 (y coordinate) value: <input type="number" name="" id="y1"></p>
    <p>Enter the values of Y2 (y coordinate) value: <input type="number" name="" id="y2"></p>
	...
	pp.showtitle(
		`<p id="exp-title" style='width: 25vw;'>Concentration vs Angle of Rotation</p>`,
		3
	);
...
function verify_slope() {
	...
	let slope2: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('slope-inp')
	);
	...
	let s2: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('s-inp')
	);
