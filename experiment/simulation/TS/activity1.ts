...
function a1_load_questions() {}
{
	...
	question.push({
		srno: 1,
		question:
			"Select <span style='color: #018fc3'>Monocromatic Source</span>",
		ans: 'mono_source',
		hint: [
	...
	question.push({
		srno: 2,
		question:
			"Select <span style='color: #018fc3'> Unpolarized Light </span>",
	...
	question.push({
		srno: 3,
		question:
			"Select <span style='color: #018fc3'> Canada Balsm Layer </span>",
		ans: 'canada_balsm',
		hint: ['Rectangular', 'Mounted Vertically', 'Has valves attached'],
	});
	...
	question.push({
		srno: 5,
		question:
			"Select <span style='color: #018fc3'> Polarimeter Sample filled Tube </span>",
	...
	question.push({
		srno: 7,
		question:
			"Select <span style='color: #018fc3'> Scale for measuring angle of rotation </span>",
		ans: 'rotation_scale',
...
function load_higlighted_images() {
	...
	a1_labels = [
		...
		new Chemistry.Text(
			'unpolarized_light',
			new Chemistry.Point(220, 300),
			canvas
		),

		new Chemistry.Text(
			'canada_balsm',
			new Chemistry.Point(480, 300),
			canvas
		),

		new Chemistry.Text(
			'half_shade_plate',
			new Chemistry.Point(710, 300),
			canvas
		),

		new Chemistry.Text(
			'sample filled tube',
			new Chemistry.Point(1000, 400),
			canvas
		),
